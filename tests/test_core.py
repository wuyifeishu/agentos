...
class TestStateSystem:
    ...
    def test_state_reducer_merge(self):
        from agentos.state.schema import StateReducer, BaseAgentState
    ...
    def test_state_reducer_last_write_wins(self):
        from agentos.state.schema import LastWriteWinsReducer, BaseAgentState
...
class TestA2AProtocol:
    ...
    def test_agent_registry_register(self):
        from agentos.protocols.registry import AgentRegistry, AgentRecord
...
class TestWorkflowDSL:
    ...
    def test_sequential_workflow(self):
        import yaml
        from agentos.workflow import WorkflowParser, WorkflowStep, StepType
...
class TestAPIServer:
    ...
    async def test_agent_manager_create(self):
        from agentos.api.server import AgentManager, AgentConfigRequest
...
class TestIntegration:
    ...
    async def test_create_and_run_flow(self):
        ...
        from agentos.api.server import AgentManager, AgentConfigRequest, RunRequest
