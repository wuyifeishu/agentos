...
def run(action: str = "summarize", text: str = "", file_path: str = "", ratio: float = 0.3, **kwargs: Any) -> str:
    content = text
    if file_path:
        try:
    ...
    if action == "extract_keywords":
        ...
        stop = {"the","and","for","that","with","this","from","have","are","not","but","was","you","all","can","has",
                "had","been","will","they","its","their","them","our","than","then","also","into","just","about","more",
                "some","when","your","which","make","like","what","over","such","here","were","how","one","two"}
