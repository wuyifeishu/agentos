...
def run(action: str, file_path: str = "", column: str = "", group_by: str = "",
    ...
    try:
        ...
        if action == "correlation":
            ...
            for t1 in targets:
                ...
                vals1 = _numeric(t1)
                for t2 in targets:
                    if t1 == t2: row_vals.append(f"{1.0:>8.3f}")
                    elif t1 < t2: row_vals.append(f"{_pearson(vals1,_numeric(t2)):>8.3f}")
