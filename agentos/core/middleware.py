...
class TimingMiddleware(AgentMiddleware):
    ...
    def phases(self) -> list[MiddlewarePhase]:
        return [
            MiddlewarePhase.ON_START, MiddlewarePhase.PRE_LLM,
            MiddlewarePhase.POST_LLM, MiddlewarePhase.PRE_TOOL,
            MiddlewarePhase.POST_TOOL, MiddlewarePhase.ON_COMPLETE,
...
class MiddlewarePipeline:
    ...
    async def run(
        ...
        if phases is None:
            phases = [
                MiddlewarePhase.ON_START, MiddlewarePhase.PRE_LLM,
                MiddlewarePhase.POST_LLM, MiddlewarePhase.ON_COMPLETE,
            ]
